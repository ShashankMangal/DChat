...
public class SignInActivity extends AppCompatActivity {
    ...
    private Boolean isValidSignInDetails()
    {
        ...
        {
            binding.signInEmail.setError("Enter Email !");
            return false;
        }
        else if(!Patterns.EMAIL_ADDRESS.matcher(binding.signInEmail.getText().toString()).matches())
        {
            binding.signInEmail.setError("Enter valid Email !");
            return false;
        }
        else if(binding.signInPassword.getText().toString().isEmpty())
        {
            binding.signInEmail.setError("Enter Password !");
            return false;
        }
        return true;
    }

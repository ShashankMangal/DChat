...
import com.sharkBytesLab.DChat.Adapters.ChatAdapter;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage()
    {
        ...
        message.put(Constants.KEY_MESSAGE, binding.chatInputMessage.getText().toString());
        message.put(Constants.KEY_TIMESTAMP, new Date());
        database.collection(Constants.KEY_COLLECTION_CHAT).add(message);
        if(conversationId!=null)
        {
            updateConversation(binding.chatInputMessage.getText().toString());
        }
        else
        {
            ...
            conversation.put(Constants.KEY_LAST_MESSAGE, binding.chatInputMessage.getText().toString());
    ...
    private void listenAvailabilityOfReceiver()
    {
        database.collection(Constants.KEY_COLLECTION_USERS)
                .document(receiverUser.id).addSnapshotListener(ChatActivity.this, (value, error) ->
                {
                   ...
                   {
                       binding.chatTextAvailability.setVisibility(View.VISIBLE);
                   }else
                   {
                       binding.chatTextAvailability.setVisibility(View.GONE);
                   }
                });
    }
    ...
    private void setListeners()
    {
        ...
        binding.chatLayoutSend.setOnClickListener(v -> sendMessage());
    }
    ...
    private void checkForConversationRemotely(String senderId, String receiverId)
    {
        database.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
                ...
                .get()
                .addOnCompleteListener(conversationOnCompleteListsner);
    }

    private final OnCompleteListener<QuerySnapshot> conversationOnCompleteListsner = task ->
    {

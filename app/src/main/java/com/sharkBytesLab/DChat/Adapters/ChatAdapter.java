...
import com.sharkBytesLab.DChat.databinding.ItemContainerReceivedMessageBinding;
import com.sharkBytesLab.DChat.databinding.ItemContainerSentMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    static class SentMessageViewHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            binding.sentTextMessage.setText(chatMessage.message);
            binding.sentTextdateTime.setText(chatMessage.dateTime);
        }
    ...
    static class ReceivedMessageViewHolder extends RecyclerView.ViewHolder
    {
        ...
        void setData(ChatMessage chatMessage, Bitmap receiverProfileImage)
        {
            ...
            binding.receivedImageProfile.setImageBitmap(receiverProfileImage);
        }
